...
class getAppCustomAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Security\\AppCustomAuthenticator'])) {
            return $container->privates['App\\Security\\AppCustomAuthenticator'];
        }

        return $container->privates['App\\Security\\AppCustomAuthenticator'] = new \App\Security\AppCustomAuthenticator($a);
    }
}
