...
class __TwigTemplate_83f4f7a697c98780e1609c0090c79437 extends Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["name"] => $context["client"]) {
                ...
                if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 61)) == 0)) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["trace"]) {
                        ...
                        // line 94
                        echo "                                        ";
                        if ((twig_get_attribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", true, true, false, 94) && twig_get_attribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", false, false, false, 94))) {
                            // line 95
                            echo "                                            <th>
                        ...
                        echo "                                    <tr>
                                        ...
                                        <td";
                        // line 110
                        if ((twig_get_attribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", true, true, false, 110) && twig_get_attribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", false, false, false, 110))) {
                            echo " colspan=\"2\"";
                        }
                        echo ">
                                            ";
...
{% endblock %}
", "@WebProfiler/Collector/http_client.html.twig", "/home/antoine/Bureau/FormatioAfpa/the_district_sym/vendor/symfony/web-profiler-bundle/Resources/views/Collector/http_client.html.twig");
    }
}
