...
class getContactRepositoryService extends App_KernelProdContainer
{
    ...
    {
        return $container->privates['App\\Repository\\ContactRepository'] = new \App\Repository\ContactRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
